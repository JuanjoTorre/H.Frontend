...
/*************************FORMULARIO DE  NUEVO GRUPOS RESTRINGIDOS
 * ********************************************************************* */
...
export const FormGRestringido = () => {
    ...
    const saveGRestringido = async (e) => {
        ...
        if (newGRestringido === "") {
            ...
            try {
                ...
                const request = await fetch(Global.url + "restringido/nuevoRestringido", {
                    method: "POST",
            ...
            setTimeout(() => {
                //Redirecciono hacia el crudGRestringido
    ...
    return (
        <main className="layout__main">
            <div className="main__titulo">
                <p className="titulo__text">Grupo Restringido</p>
            </div>

            <div className="main__formulario main__formulario-resto">
                <div className="formulario__box formulario__box-resto" onSubmit={saveGRestringido}>
