...
export const FormProducto = () => {
	...
	const [sin_azucar, setAzucar] = useState(false);
	const [sin_gluten, setGluten] = useState(false);
	...
	const [lote, setLotes] = useState(false);
	...
	const proveedores = async () => {
		try {
			...
			const request = await fetch(
				Global.url + "proveedor/listarProveedor",
				{
					method: "GET",
					headers: {
	...
	const genericos = async () => {
		try {
			...
			const request = await fetch(
				Global.url + "generico/ListarGenerico",
				{
					method: "GET",
					headers: {
						"Content-Type": "application/json",
	...
	const concretos = async () => {
		try {
			...
			const request = await fetch(
				Global.url + "concreto/listarConcreto",
				{
					method: "GET",
					headers: {
						"Content-Type": "application/json",
	...
	const saveProducto = async (e) => {
		...
		try {
			...
			const request = await fetch(
				Global.url + "producto/nuevoProducto",
				{
					method: "POST",
	...
	return (
		<main className="layout__main">
			...
			<div className="main__formulario main__formulario-producto">
				<form
					action=""
					className="formulario__form formulario__form-producto"
						...
						<div className="formulario__boxCajaUno">
							<div className="formulario__boxIzda">
								<div className="form__linea form__linea-producto">
									<label className="form__label form__label-producto">
										Nombre
									</label>
									<input
										type="text"
							...
							<div className="formulario__boxDcha">
								...
								<div className="boxDcha__dos">
									<label className="varios__titulo">
										Restringidos
									</label>
									<div className="varios__restringidos">
										<div className="restringidos__elemento">
											<label className="restringidos__elemento-titulo">
												Integral
											</label>
											<input
												type="checkbox"
										...
										<div className="varios__azucar">
											<label className="varios__azucar-titulo">
												Sin
												Azucar
											</label>
											<input
										...
										<div className="varios__gluten">
											<label className="varios__gluten-titulo">
												Sin
												Gluten
											</label>
											<input
								...
								<div className="boxDcha__tres">
									...
									<div className="varios__dirigidos">
										<div className="varios__alimentacion">
											<label className="varios__alimentacion-titulo">
												Alimentacion
											</label>
											<input
												type="checkbox"
										...
										<div className="varios__hosteleria">
											<label className="varios__hosteleria-titulo">
												Hosteleria
											</label>
											<input
												type="checkbox"
										...
										<div className="varios__vending">
											<label className="varios__vending-titulo">
												Vending
											</label>
											<input
												type="checkbox"
										...
										<div className="varios__lotes">
											<label className="varios__lotes-titulo">
												Lote
											</label>
											<input
												type="checkbox"
