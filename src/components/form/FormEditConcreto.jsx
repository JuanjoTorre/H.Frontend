/*******************************FORMULARIO DE  EDICION DE CONCRETOS
 * ********************************************************************* */
    ...
    const editConcreto = async (e) => {
        ...
        if (newConcreto === "") {
            ...
            try {
                ...
                const request = await fetch(Global.url + `concreto/editarConcreto/${location.state.id}`, {
                    method: "PUT",
    ...
    return (
        <main className="layout__main">
            ...
            <div className="content__repuesta">
                {saved == "Not_Saved" ? "" : ""}
                {saved == "saved" ? <strong className="alert alert-success">Concreto editado con exito </strong> : ""}
