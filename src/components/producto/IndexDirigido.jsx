/********LAYOUT DE IMAGENES DE PRODUCTOS DE UN DIRIGIDO A
 * ************************************************************* */
...
export const IndexDirigido = () => {
    ...
    const iniciar = async () => {
        ...
        try {
            //Obtengo un listado de productos del dirigido
            const request = await fetch(Global.url + `producto/listarProductosDirigido/${tipo}`, {
                method: "GET",
                headers: {
