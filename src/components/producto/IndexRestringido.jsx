/********LAYOUT DE IMAGENES DE PRODUCTOS DE UN GRUPO RESTRINGIDO
 * ********************************************************************* */
...
export const IndexRestringido = () => {
    ...
    const iniciar = async () => {
        ...
        try {
            //Obtengo un listado de productos del restringido
            const request = await fetch(Global.url + `producto/listarProductosRestringido/${tipo}`, {
                method: "GET",
                headers: {
