/*****************LAYOUT DE IMAGENES DE PRODUCTOS DE UN PROVEEDOR
 * ********************************************************************* */
...
export const IndexProveedor = () => {
    ...
    const iniciar = async () => {
        ...
        try {
            //Obtengo un listado de productos del proveedor
            const request = await fetch(Global.url + `producto/listarProductosProveedor/${tipo}`, {
                method: "GET",
                headers: {
